    ...
    return (
        <>
            <div className={`fixed w-full h-full z-20 ${transformUp === true ? 'translate-y-[-700px] opacity-0' : ''} duration-700 cover-1`}>
                <div className='absolute bg-[#531212] w-full h-full'></div>
                <div className='absolute w-full h-full'>
                    <div className='absolute top-1/4 left-0 right-0'>
                        <div className='text-center'>
                            ...
                            <p className='text-[#FFFFFF] text-sm md:text-lg mb-3 lg:mx-96 md:mx-32 mx-8'>
                                Tanpa Mengurangi Rasa Hormat, Kami Mengundang Anda Untuk Berhadir Di Acara Pernikahan Kami.
                            </p>
                            <button type="button" onClick={onClick} class="text-white text-md bg-[#000000] hover:bg-[#FFFFFF] hover:text-black font-bold rounded-xl px-5 py-3.5 mr-2 mb-2">
