  ...
  return (
    <>
      <div className='my-16'>
        ...
        <h1 data-aos="fade-up" className='text-center text-4xl font-semibold custom-font-3 mx-4 mb-16 text-[#202547]'>Waktu & Lokasi <br /> Acara</h1>
        ...
        <center>
          <div data-aos="fade-up" className='max-w-4xl mx-6 rounded-xl'>
            ...
            <center>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/place/Universitas+Siliwangi/@-7.3499198,108.220182,17z/data=!3m1!4b1!4m6!3m5!1s0x2e6f5765c64bb1f9:0xd8b04746f0f62ad4!8m2!3d-7.3499251!4d108.2227569!16s%2Fg%2F122qxyts?entry=ttu" className="text-white text-md bg-[#202547] hover:bg-[#81a5ba] font-bold rounded-xl px-5 py-3.5 mr-2 mb-2">
