    ...
    return (
        <>
            <div id="gift" className='my-16'>
                ...
                <h1 data-aos="fade-up" className='text-center text-2xl font-semibold custom-font-3 mx-4 text-[#202547]'>Menuju Waktu Acara</h1>
                <h1 data-aos="fade-up" className='text-center text-4xl font-semibold custom-font-3 mx-4 mb-8 text-[#202547]'>Pernikahan Kami</h1>
                <div data-aos="fade-up" className='flex justify-center gap-4 mb-8'>
                    <div className='rounded-xl md:w-[200px] w-[80px] py-6 bg-[#202547] text-center custom-font-3 text-white'>
                ...
                <h1 data-aos="fade-up" className='text-center text-2xl font-semibold custom-font-3 mx-4 text-[#202547] mb-4'>Untuk Yang Berhalangan Hadir, Kami Tambahkan Fitur Dibawah Ini</h1>
                <div data-aos="fade-up" className='flex justify-center'>
                    <button type="button" onClick={() => openAmplop()} className="text-white shadow-lg text-md bg-[#202547] hover:bg-[#81a5ba] font-bold rounded-xl px-5 py-3.5 mr-2 mb-2">
                        <FontAwesomeIcon icon={faMoneyBill1} /> Amplop
                    </button>
                    <button type="button" onClick={() => openKado()} className="text-white shadow-lg text-md bg-[#202547] hover:bg-[#81a5ba] font-bold rounded-xl px-5 py-3.5 mr-2 mb-2">
                        <FontAwesomeIcon icon={faGift} /> Kirim Kado
                    </button>
                </div>
            </div>
            <div className='mt-16 bg-[#dde7ee] py-8'>
                <h1 data-aos="fade-up" className='text-center text-[#202547] text-3xl font-semibold custom-font-3 mx-4 mb-4'>Konfirmasi Kehadiran</h1>
                <div data-aos="fade-up" className='max-w-lg mx-auto mb-16'>
                    <div className='mx-4'>
                        ...
                        <label className='text-left font-semibold text-[#202547]'>Konfirmasi</label>
                        <div class="flex items-center mt-2" onClick={() => {setRsvpKonfir('Iya, Saya Akan Datang')}}>
                            ...
                            <label for="default-radio-1" class="ml-2 text-sm font-medium text-[#202547]">Iya, Saya Akan Datang</label>
                        </div>
                        <div class="flex items-center mt-2 mb-4" onClick={() => {setRsvpKonfir('Maaf, Saya Tidak Bisa Datang')}}>
                            ...
                            <label for="default-radio-2" class="ml-2 text-sm font-medium text-[#202547]">Maaf, Saya Tidak Bisa Datang</label>
                        </div>
                        <button onClick={() => {reservasi()}} className='py-3 bg-[#202547] rounded-full w-full mb-4 text-white hover:bg-[#81a5ba]'>
                            <FontAwesomeIcon icon={faMessage} className="mr-2" />
                            Reservasi via Whatsapp
                        </button>
                    </div>
                </div>
                <h1 data-aos="fade-up" className='text-center text-[#202547] text-2xl font-semibold custom-font-3 mx-4'>Kirim Pesan</h1>
                <h1 data-aos="fade-up" className='text-center text-[#202547] md:text-4xl text-2xl font-semibold custom-font-3 mx-4 mb-4'>Untuk Kedua Mempelai</h1>
                <div data-aos="fade-up" className='max-w-lg mx-auto mb-16'>
                    <div className='mx-4'>
                        ...
                        <div className='flex justify-between '>
                            {
                                btnLoader === false ?
                                    <button onClick={() => addUcapan()} className='py-3 px-4 bg-[#202547] rounded-xl  mb-4 text-white hover:bg-[#bc5b5b]'>
                            ...
                            <h1 className='custom-font-4 text-[#202547] mt-2'>{ucapan.length} Pesan</h1>
                        </div>
